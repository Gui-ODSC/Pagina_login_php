...
<body id="tela-b">
    ...
    <div id="tela-A">
        <h1>B</h1>
        <a href="AreaPrivada_A.php"><button style="background: #DAA520; width: 150px; border-radius: 6px; padding: 15px; cursor: pointer; color: black; border: none; font-size: 16px margin 0px;"><strong>Página A</strong></button></a>
    </div>
</body>
</html>